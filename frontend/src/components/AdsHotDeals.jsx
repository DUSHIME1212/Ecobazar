...
const AdsHotDeals = () => {
  return (
    <div className="w-full h-[512px] flex flex-col lg:flex-row gap-6 my-12">
      {/* 85% Fat Free Banner */}
      <div
        className="w-full lg:w-1/3 min-h-[400px] rounded-xl relative overflow-hidden group shadow-md"
        style={{
          backgroundImage: `url('/timestamp/Rectangle 54.png')`,
      ...
      >
        ...
        <div className="relative h-full flex flex-col justify-center items-center text-center p-8 text-white gap-4">
          ...
          <h1 className="text-4xl leading-tight uppercase tracking-tight">
            Low-Fat Meat
          </h1>
      ...
      <div
        className="w-full lg:w-1/3 min-h-[400px] rounded-xl relative overflow-hidden group shadow-md"
        style={{
          backgroundImage: `url('/timestamp/Rectangle 54 (1).png')`,
          backgroundSize: "cover",
          backgroundPosition: "center",
        }}
      >
      ...
      {/* Drink Banner */}
      <div className="w-full lg:w-1/3 min-h-[400px] rounded-xl relative overflow-hidden group shadow-md bg-[#1A1A1A]">
        <img
          src="/timestamp/Rectangle 54 (2).png"
          className="absolute inset-0 w-full h-full object-cover opacity-60 group-hover:scale-110 transition-transform duration-700"
          alt="Drink"
        />
        <div className="relative h-full flex flex-col justify-center items-center text-center p-8 text-black gap-4">
          ...
          <p className="text-lg font-medium">
            Up to <span className=" text-2xl ml-1">45% OFF</span>
          </p>
          <Link to="/shop">
