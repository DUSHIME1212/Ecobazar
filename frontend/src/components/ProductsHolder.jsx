...
const ProductsHolder = ({ imag, name, newprise, oldprise, rate, sale }) => {
  return (
    <div className="w-1/5 flex flex-col justify-between group border relative border-black/20 hover:shadow-2xl hover:shadow-green-500/20 hover:border-green-500 p-2 min-h-80">
      {sale ? (
