...
const HomepageLanding = () => {
  const banner = "/Bannar Big.png";
  return (
    <div>
      <div className="w-full min-h-[512px] px-8 md:px-16 lg:px-32 grid grid-cols-3 gap-2 grid-rows-2 mt-2">
        <div
          className="col-span-2 rounded-xl row-span-2 bg-green-500 relative"
          style={{ backgroundImage: `url(${banner})` }}
        >
          <div className="p-2 flex flex-col gap-4 absolute top-8 left-8">
            ...
            <div className="p-4 size-fit border-l-4 flex flex-col gap-2 border-green-200">
              <h1 className="text-lg">
                Sale up to{" "}
                <span className="p-2 bg-orange-400 rounded-lg">30% OFF</span>
              </h1>
        ...
        <div className="col-span-1 rounded-xl bg-green-300 relative">
        ...
        <div className="col-span-1 rounded-xl grid place-items-center bg-gray-300">
