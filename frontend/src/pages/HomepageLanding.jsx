  ...
  return (
    <div className="px-8 md:px-16 lg:px-32 flex flex-col gap-4">
      <div className="w-full min-h-[512px] grid grid-cols-3 gap-2 grid-rows-2 mt-2">
          ...
          <div className="p-2 flex text-white w-2/3 flex-col gap-4 absolute top-8 left-8">
            ...
            <div className="p-4 size-fit border-l-4 flex flex-col gap-2 border-green-200">
              <h1 className="text-lg">
                Sale up to{" "}
                <span className="p-2 ml-2 bg-orange-400 rounded-lg">30% OFF</span>
              </h1>
        ...
        <div className="col-span-1 rounded-xl bg-green-300 relative" style={{ backgroundImage: `url('/BG.png') `}}>
        ...
        <div className="col-span-1 rounded-xl grid place-items-center bg-gray-300 text-white" style={{ backgroundImage: `url('/Bannar.png') `}}>
      ...
      <div className="grid grid-rows-4 md:grid-cols-2 md:grid-rows-2 lg:grid-cols-4 rounded-3xl shadow-lg">
        <div className="p-4 flex items-center">
          <img src={"/img/delivery-truck 1.png"} className="size-12" alt="product1" />
