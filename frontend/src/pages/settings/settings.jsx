    ...
    <main className="">
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-3/4">
            ...
            <div className="flex flex-col border rounded-md w-full lg:min-w-[50dvw] min-h-[66dvh] mt-7 mr-4">
              ...
              <div className="flex justify-between p-5 space-y-4" id="content">
                ...
                <div className="flex flex-col items-center w-[15dvw]">
                  ...
                  <label
                    htmlFor="imageInput"
                    className="cursor-pointer rounded-full border-2 w-[130px] h-[38px] flex items-center justify-center font-semibold text-green-600 border-solid border-green-600"
                  >
                    Change Image
                  </label>
                </div>
          ...
          <div className="p-4 border rounded-md min-w-[50dvw] h-[38dvh] mt-4">
            yoo
          </div>
        </div>
      </div>
